...
use FSW\Exception\ListPermission as ListPermissionException,
    FSW\Exception\MissingField as MissingFieldException,
...
class UserList extends ServiceLocatorAwareGateway
{
     ...
     *
     * @param \FSW\Db\Row\User|bool $user Logged-in user (false if none)
     *
     * @return bool
     */
