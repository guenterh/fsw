...
class User extends ServiceLocatorAwareGateway
{
     ...
     * @throws \FSW\Exception\PasswordSecurity
     */
    ...
    protected function encryptOrDecrypt($text, $encrypt = true)
    {
        ...
        if (null === $this->encryptionKey) {
            ...
            if (!isset($config->Authentication->ils_encryption_key)
                ...
                throw new \FSW\Exception\PasswordSecurity(
     ...
     *
     * @param \FSW\Db\Row\Resource $resource        The resource to add/update
     * @param \FSW\Db\Row\UserList $list            The list to store the resource
     * in.
