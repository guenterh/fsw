 ...
 */
namespace FSW\Auth;
use FSW\Exception\Auth as AuthException, Zend\Crypt\Password\Bcrypt;
...
class Database extends AbstractBase
{
     ...
     * @return \FSW\Db\Row\User Object representing logged-in user.
     */
     ...
     *
     * @throws AuthException
     * @return \FSW\Db\Row\User New user row.
     */
