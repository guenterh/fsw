 ...
 */
namespace   FSW\Auth;
use FSW\Db\Row\User as UserRow, FSW\Db\Table\User as UserTable,
    FSW\Exception\Auth as AuthException,
...
class Manager
{
    ...
    public function login($request)
    {
        ...
        try {
            ...
            throw $e;
        } catch (\FSW\Exception\PasswordSecurity $e) {
