 ...
 */
namespace FSW\Auth;
use FSW\Db\Row\User, FSW\Exception\Auth as AuthException;
 ...
 * @link     http://www.vufind.org  Main Page
 */
abstract class AbstractBase implements \FSW\Db\Table\DbTableAwareInterface,
     \Zend\Log\LoggerAwareInterface
{
     ...
     *
     * @var \FSW\Db\Table\PluginManager
     */
     ...
     *
     * @param \FSW\Db\Table\PluginManager $manager Plugin manager
     *
     * @return void
     */
    public function setDbTableManager(\FSW\Db\Table\PluginManager $manager)
    {
